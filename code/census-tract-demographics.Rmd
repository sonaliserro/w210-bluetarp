...
setnames(d_race_us, old = c('Estimate!!Total!!Total population!!Hispanic or Latino origin (of any race)',
                      ...
                      new = c('us_total_hispanic_rate',
                              'in_state_hispanic_rate',
                              'out_state_hispanic_rate',
                              'outside_us_hispanic_rate',
                              'total_white_rate',
                              'in_state_white_rate',
                              'out_state_white_rate',
                              'outside_us_white_rate'))

# Keep required fields
d_race_us <- d_race_us[ , c('censusid', 'us_total_hispanic_rate', 'in_state_hispanic_rate', 'out_state_hispanic_rate',
                            'outside_us_hispanic_rate', 'total_white_rate', 'in_state_white_rate',
                            'out_state_white_rate', 'outside_us_white_rate')]
...
# Rename fields
setnames(d_race_pr, old = c('Estimate!!Total!!Total population!!Hispanic or Latino origin (of any race)',
                      ...
                      new = c('pr_total_hispanic_rate',
                              'pr_born_in_hispanic_rate',
                              'pr_born_us_hispanic_rate',
                              'pr_born_outside_hispanic_rate',
                              'pr_total_white_rate',
                              'pr_born_in_white_rate',
                              'pr_born_us_white_rate',
                              'pr_born_outside_white_rate'))

# Keep required fields
d_race_pr <- d_race_pr[ , c('censusid', 'pr_total_hispanic_rate', 'pr_born_in_hispanic_rate', 'pr_born_us_hispanic_rate',
                              'pr_born_outside_hispanic_rate', 'pr_total_white_rate', 'pr_born_in_white_rate',
                              'pr_born_us_white_rate', 'pr_born_outside_white_rate')]
