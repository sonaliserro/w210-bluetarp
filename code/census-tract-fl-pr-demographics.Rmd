---
title: 'Census Tract Demographics - Puerto Rico & Florida'
...
filenames <- list.files('../data/census-tract-fl-pr/raw/', pattern='*.csv', full.names=TRUE)
...
```{r}
# Read data
d_population <-read_data(file = '../data/census-tract-fl-pr/raw/population.csv')
d_population
...
```{r}
# Read data
d_education <-read_data(file = '../data/census-tract-fl-pr/raw/educational-attainment.csv')
d_education
...
```{r}
# Read data
d_employment <-read_data(file = '../data/census-tract-fl-pr/raw/employment-status.csv')
d_employment
...
```{r}
# Read data
d_income <-read_data(file = '../data/census-tract-fl-pr/raw/family-income.csv')
d_income
...
```{r}
# Read data
d_earnings <- read_data(file = '../data/census-tract-fl-pr/raw/median-earnings.csv')
d_earnings
...
```{r}
# Read data
d_poverty <-read_data(file = '../data/census-tract-fl-pr/raw/poverty-status.csv')
d_poverty
...
```{r}
# Read data
d_assistance <-read_data(file = '../data/census-tract-fl-pr/raw/public-assistance.csv')
d_assistance
...
```{r}
# Read data
d_housing <- read_data(file = '../data/census-tract-fl-pr/raw/housing-characteristics.csv')
d_housing
...
```{r}
# Write to csv
fwrite(d_full, file = '../data/census-tract-fl-pr/census-tract-fl-pr-demographics2.csv')
```
