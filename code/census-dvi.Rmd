...
calculate_dvi <- function(d = d_census, state_val = 'all') {
  ...
  ### Poverty Rate ###
  # Drop NAs
  d_valid <- d[!is.na(below_poverty_rate), c('censusid', 'below_poverty_rate')]
  ...
  ### Unemployed Rate ###
  # Drop NAs
  d_valid <- d[!is.na(unemployed_labor_rate), c('censusid', 'unemployed_labor_rate')]
  ...
  ### Median Earnings ###
  # Drop NAs
  d_valid <- d[!is.na(median_earnings_total), c('censusid', 'median_earnings_total')]
  ...
  ### Owner Occupied Rate ###
  # Drop NAs
  d_valid <- d[!is.na(owner_occupied_rate), c('censusid', 'owner_occupied_rate')]
  ...
  ### House Built Year ###
  # Drop NAs
  d_valid <- d[!is.na(built_1979_or_earlier_rate), c('censusid', 'built_1979_or_earlier_rate')]
